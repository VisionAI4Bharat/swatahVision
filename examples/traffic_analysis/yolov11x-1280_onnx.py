...
class VideoProcessor:
    def __init__(
        ...
        self.model = sv.Model(source_weights_path, engine=sv.Engine.ONNX, hardware=sv.Hardware.GPU)
    ...
    def process_frame(self, frame: np.ndarray) -> np.ndarray:
        ...
        detections = sv.Detections.from_yolo(results, conf_threshold=self.conf_threshold, nms_threshold=self.iou_threshold)
